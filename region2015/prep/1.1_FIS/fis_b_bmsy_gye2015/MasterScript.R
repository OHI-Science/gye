...
cdat <- read.csv("Data.csv", stringsAsFactors=FALSE)


## Run bbmsy script
source('cmsy_uniform.R')
#source('cmsy_relaxed.R')
...
write.csv(b_bmsy, "my_bbmsy_uniform2_04182015.csv", row.names=FALSE) # Does not consider resilience. Uniform priors
#write.csv(b_bmsy, "my_bbmsy_relaxed_04172015.csv", row.names=FALSE) #Considers Resilience and relaxed priors
