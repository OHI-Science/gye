...
Capa de datos con el área actual total de manglar 1km costa adentro y 1km costa afuera, para cada región del Golfo de Guayaquil.

8. Observación o comentario adicional sobre los datos.
Para el estudio global, los datos fueron calificados de acuerdo a un modelo combinado, lo que quiere decir que los datos fueron tomados de diferentes fuentes y fueron hechas combinaciones con diferentes modelos. 
