...
# Edit text for the following pages:
  # homepage: ~/github/gye/index.md
  # regions:  ~/github/gye/regions/index.md
  # layers:   ~/github/gye/layers/index.md
       # edit the header text only. To edit layer descriptions, modify layers.csv in the draft branch.
  # goals:    ~/github/gye/goals/index.md
  ...
  # scores:   ~/github/gye/scores/index.md
